...
public class Main {
    public static void main(String[] args) {
        ...
        if(!checkPoint(a,b,c)){
            System.out.println("По заданным точкам невозможно построить треугольник, эллипс и квадрат!");
            System.exit(1);
        }
        ...
        Ellips el1 = new Ellips(a, b, c, Colour.RED);
        List<Shape> ls = List.of(tr1,crl1,sq1, el1);
        System.out.println("Набор представлен следующими фигурами: " + "\n" + ls);
        System.out.println("Максимальная площадь равна " + Math.round(maxSquare(ls)));
